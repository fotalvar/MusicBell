...
Se incluye un icono personalizado para facilitar el lanzamiento:

- Ejecuta `crear_acceso_directo.bat` como administrador
- Se creará un acceso directo en tu Escritorio con el icono
- También puedes usar `MusicBell.vbs` para ejecutar sin consola

👉 **[Más información sobre el icono →](ICONO_WINDOWS.md)**
